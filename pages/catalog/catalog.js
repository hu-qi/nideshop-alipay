...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["currentCategory", "navList", "goodsCount", "categoryList", "scrollLeft", "scrollTop", "scrollHeight"], _this.state = {
      navList: [],
      categoryList: [],
      currentCategory: {},
      scrollLeft: 0,
    ...
    }, _this.getCurrentCategory = function (id) {
      var that = _this;
      ...
      var that = _this;
      util.request(api.ApiRootUrl + 'api/catalog/' + that.data.currentCategory.cat_id).then(function (res) {
        that.setData({
          categoryList: res.data
        });
      });
    }, _this.switchCate = function (event) {
      var that = _this;
      var currentTarget = event.currentTarget;
      if (_this.data.currentCategory.id == event.currentTarget.dataset.id) {
        return false;
      }

      _this.getCurrentCategory(event.currentTarget.dataset.id);
  ...
  return _C;
}(_index2.default.Component), _class2.$$events = ["switchCate"], _temp2)) || _class);
