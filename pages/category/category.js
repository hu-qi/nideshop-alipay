...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["scrollLeft", "id", "navList", "scrollTop", "scrollHeight", "goodsList", "currentCategory", "page", "size"], _this.state = {
      // text:"这是一个页面"
      navList: [],
      goodsList: [],
      id: 0,
      ...
      page: 1,
      size: 10000
    }, _this.getCategoryInfo = function () {
      var that = _this;
      util.request(api.GoodsCategory, { id: _this.data.id }).then(function (res) {
        if (res.errno == 0) {
          that.setData({
      ...
      if (_this.data.id == event.currentTarget.dataset.id) {
        return false;
      }
      var that = _this;
