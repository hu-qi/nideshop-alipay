...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["scrollTop", "topicList", "showPage", "page", "count", "size"], _this.state = {
      // text:"这是一个页面"
      topicList: [],
      page: 1,
      size: 10,
      ...
      console.log();
      var that = _this;
      if (_this.data.page + 1 > that.data.count / that.data.size) {
        return true;
      }
  ...
  return _C;
}(_index2.default.Component), _class2.$$events = ["prevPage", "nextPage"], _temp2)) || _class);
