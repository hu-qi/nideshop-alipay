...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["footprintList"], _this.state = {
      footprintList: []
    }, _this.getFootprintList = function () {
      var that = _this;
  ...
  _createClass(_C, [{
    ...
    value: function _createData() {
      ...
      var footprintList = this.__state.footprintList;
  ...
  return _C;
}(_index2.default.Component), _class2.$$events = ["touchStart", "touchEnd", "deleteItem"], _temp2)) || _class);
