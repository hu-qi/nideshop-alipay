...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["collectList", "typeId"], _this.state = {
      typeId: 0,
      collectList: []
    }, _this.getCollectList = function () {
      var that = _this;
    ...
    }, _this.openGoods = function (event) {
      var that = _this;
      var goodsId = _this.data.collectList[event.currentTarget.dataset.index].value_id;
  ...
  _createClass(_C, [{
    ...
    value: function _createData() {
      ...
      var collectList = this.__state.collectList;
  ...
  return _C;
}(_index2.default.Component), _class2.$$events = ["openGoods", "touchStart", "touchEnd"], _temp2)) || _class);
