...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["expressInfo", "key", "expressTraces", "orderId"], _this.state = {
      orderId: 1,
      expressInfo: {},
      expressTraces: []
    }, _this.getExpressInfo = function () {
      var that = _this;
  ...
  _createClass(_C, [{
    ...
    value: function _createData() {
      ...
      var _state = this.__state,
          expressInfo = _state.expressInfo,
          expressTraces = _state.expressTraces,
          key = _state.key;
  ...
  return _C;
}(_index2.default.Component), _class2.$$events = ["updateExpress"], _temp2)) || _class);
