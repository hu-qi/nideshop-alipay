...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    }, _this.bindConfirmPasswordInput = function (e) {
      _this.setData({
  ...
  _createClass(_C, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp3 = confirmPassword.length > 0 ? "/static/images/clear_input.png" : null;
      var anonymousState__temp4 = code.length > 0 ? "/static/images/clear_input.png" : null;
  ...
  return _C;
}(_index2.default.Component), _class2.$$events = ["bindUsernameInput", "clearInput", "bindPasswordInput", "bindConfirmPasswordInput", "bindCodeInput", "startRegister"], _temp2)) || _class);
