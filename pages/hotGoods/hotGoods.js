...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray0", "bannerInfo", "currentSortType", "currentSortOrder", "categoryFilter", "filterCategory", "goodsList", "categoryId", "page", "size"], _this.state = {
      bannerInfo: {
        img_url: '',
        name: ''
      },
      ...
      _this.setData({
        categoryFilter: false,
        categoryId: _this.data.filterCategory[currentIndex].id
      });
      _this.getData();
  ...
  _createClass(_C, [{
    ...
    value: function _createData() {
      ...
      var loopArray0 = filterCategory.map(function (item, index) {
        item = {
          $original: (0, _index.internal_get_original)(item)
        };
        var $loopState__temp2 = 'cate-' + item.$original.id;
        return {
  ...
  return _C;
}(_index2.default.Component), _class2.$$events = ["openSortFilter", "selectCategory"], _temp2)) || _class);
