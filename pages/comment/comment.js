...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["showType", "comments", "allCount", "hasPicCount", "allCommentList", "picCommentList", "typeId", "valueId", "allPage", "picPage", "size"], _this.state = {
      comments: [],
      allCommentList: [],
      picCommentList: [],
      typeId: 0,
  ...
  _createClass(_C, [{
    ...
    value: function _createData() {
      ...
      var _state = this.__state,
          ...
          allCount = _state.allCount,
          hasPicCount = _state.hasPicCount,
  ...
  return _C;
}(_index2.default.Component), _class2.$$events = ["switchTab"], _temp2)) || _class);
