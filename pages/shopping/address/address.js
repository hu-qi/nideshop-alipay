...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["addressList"], _this.state = {
      addressList: []
    ...
    }, _this.selectAddress = function (event) {
      console.log(event.currentTarget.dataset.addressId);

      try {
        _index2.default.setStorageSync('addressId', event.currentTarget.dataset.addressId);
      } catch (e) {}
  ...
  return _C;
}(_index2.default.Component), _class2.$$events = ["selectAddress", "addressAddOrUpdate"], _temp2)) || _class);
