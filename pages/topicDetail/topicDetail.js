...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "commentList", "commentCount", "topic", "topicList", "id"], _this.state = {
      id: 0,
      topic: {},
      topicList: [],
      commentCount: 0,
      ...
      _index2.default.navigateTo({
        url: '/pages/commentPost/commentPost?valueId=' + _this.data.id + '&typeId=1'
      });
  ...
  _createClass(_C, [{
    ...
    value: function _createData() {
      ...
      var _state = this.__state,
          topicDetail = _state.topicDetail,
          commentList = _state.commentList,
          commentCount = _state.commentCount,
          topic = _state.topic,
  ...
  return _C;
}(_index2.default.Component), _class2.$$events = ["postComment"], _temp2)) || _class);
