...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["brandList", "page", "size", "totalPages"], _this.state = {
      brandList: [],
      page: 1,
      size: 10,
      totalPages: 1
    }, _this.getBrandList = function () {
      ...
      if (_this.data.totalPages > _this.data.page) {
        _this.setData({
  ...
  _createClass(_C, [{
    ...
    value: function _createData() {
      ...
      var brandList = this.__state.brandList;
