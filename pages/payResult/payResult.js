...
var _C = (_dec = (0, _index4.default)('Page'), _dec(_class = (_temp2 = _class2 = function (_Taro$Component) {
  ...
  function _C() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _C.__proto__ || Object.getPrototypeOf(_C)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["status", "orderId"], _this.state = {
      status: false,
      orderId: 0
    }, _this.payOrder = function () {
      pay.payOrder(parseInt(_this.data.orderId)).then(function (res) {
        if(res.resultCode == '9000'){
          util.request(api.UpdatedPay, {
           orderId: parseInt(_this.data.orderId),
           payStatus: 1
          }).then(res => {
            console.log(res)
          }).catch(err => {
  ...
  _createClass(_C, [{
    ...
    value: function _createData() {
      ...
      var status = this.__state.status;
  ...
  return _C;
}(_index2.default.Component), _class2.$$events = ["payOrder"], _temp2)) || _class);
