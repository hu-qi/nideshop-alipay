...
function withWeapp(componentType) {
  var isComponent = componentType === 'Component';
  return function (ConnectComponent) {
    return (/*@__PURE__*/function (ConnectComponent) {
        function BaseComponent(props) {
          ...
          this.safeExecute = function (func) {
            ...
            if (func) {
              func.apply(this$1, arg);
            }
          };
          this.executeComponentFunc = function (func) {
            var args = [],
                len = arguments.length - 1;
            while (len-- > 0) args[len] = arguments[len + 1];

            if (isComponent) {
              this$1.safeExecute(func, args);
            }
          };
          this.setData = function (obj) {
            var state = Object.assign({}, this$1.state);
            Object.keys(obj).forEach(function (key) {
              set_1(state, key, obj[key]);
            });
            Object.assign(this$1.state, state);
        ...
        BaseComponent.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
          ...
          if (Array.isArray(this._observeProps)) {
            this._observeProps.forEach(function (ref) {
              ...
              if (!isEqual_1(prop, nextProp)) {
                if (typeof observer === 'string') {
                  var ob = this$1[observer];
                  if (isFunction$1(ob)) {
                    ob.call(this$1, nextProp, prop, key);
                  }
                } else if (isFunction$1(observer)) {
                  observer.call(this$1, nextProp, prop, key);
                }
              }
            });
          }
          this.executeComponentFunc.call(this, ConnectComponent.prototype.componentWillReceiveProps);
        };
        BaseComponent.prototype.componentWillMount = function componentWillMount() {
          this.executeComponentFunc(this.created);
          if (ConnectComponent.prototype.componentWillMount) {
            ConnectComponent.prototype.componentWillMount.call(this, this.$router.params);
          }
        };
