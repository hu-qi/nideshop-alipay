...
var ApiRootUrl = 'https://nideshop-api.fashaoge.com/api/';
...
module.exports = {
  ...
  AuthLoginByAlipay: 'https://nideshop-api.fashaoge.com/api/auth/loginByAlipay', //支付宝登录
  ...
  CollectAddOrDelete: 'https://nideshop-api.fashaoge.com/api/collect/addordelete', //添加或取消收藏
  ...
  SearchClearHistory: 'https://nideshop-api.fashaoge.com/api/search/clearhistory', //搜索帮助
